...
export const SCENARIOS = Object.freeze({
  "zh-HK": [
    ...
    },
    {
      ...
      defaultAction: "SPEAK",
      tag: "已上車想入走廊？",
      primaryScript: "「麻煩借少少位，等我入中間企，唔塞住大家，唔該。」",
    ...
    },
    {
      ...
      defaultAction: "SPEAK",
      tag: "車廂人貼人時碰到／輕撞到人？",
      primaryScript: "「唔好意思！好迫撞到你，下站有人落車無咁迫，唔好意思。」",
      fallbackScript: "「架車煞得急撞到，真係唔好意思，大家小心。」",
    ...
    },
    {
      ...
      defaultAction: "SPEAK",
      tag: "想落車借過？",
      primaryScript: "「唔好意思借借，我落車，出咗大家都鬆啲，唔該。」",
      fallbackScript: "「唔好意思，麻煩借借落車，大家都有位企。」",
    ...
    },
    {
      ...
      defaultAction: "SILENT",
      tag: "被背囊頂／無扶手？",
      primaryScript: "「唔好意思，架車太晃，借位一齊扶扶？唔該。」",
      fallbackScript: "「唔好意思，好逼扶唔到，借少少位，唔該晒。」",
    ...
    },
    {
      ...
      defaultAction: "SILENT",
      tag: "開喇叭睇片／講電話太大聲？",
      primaryScript: "「唔好意思，車廂好逼，可否稍微較細少少？唔該晒你。」",
      fallbackScript: null,
  ...
  "en": [
    ...
    },
    {
      ...
      primaryScript: "\"Excuse me, moving center so I don't crowd your space, thanks.\"",
      fallbackScript: "\"Pardon me, heading inside to free up standing room, thanks.\"",
    ...
    },
    {
      ...
      primaryScript: "\"Sorry! It's super packed—hang in there everyone, apologies!\"",
      fallbackScript: "\"Train lurched hard and bumped you, apologies, take care!\"",
    ...
    },
    {
      ...
      defaultAction: "SPEAK",
      tag: "Need to Alight?",
      primaryScript: "\"Excuse me, getting off here—more room once I'm out, thanks!\"",
      fallbackScript: "\"Pardon me, stepping out so everyone has more space, thanks.\"",
    ...
    },
    {
      ...
      primaryScript: "\"Excuse me, train's bumpy, mind sharing the pole? Thanks.\"",
      fallbackScript: "\"Pardon me, quite crowded, need a grip on the rail, thanks.\"",
    ...
    },
    {
      ...
      primaryScript: "\"Excuse me, out first then in—faster for all of us, thanks.\"",
      fallbackScript: "\"Pardon me, letting passengers exit first avoids crush, thanks!\"",
    ...
    },
    {
      ...
      primaryScript: "\"Excuse me, train's quite packed, mind turning it down? Thanks.\"",
      fallbackScript: null,
