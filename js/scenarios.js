 ...
 * 2. 社交前綴精準分工：
 *    - 自降姿態求助/共情：用「唔好意思」（door-jam, bump, space）
 *    - 正常動態借過：用「麻煩借一借」（board, alight）
 *    - 維持大局秩序：用「大家稍為等等 / 唔該」（rush, noise）
...
export const SCENARIOS = Object.freeze({
  "zh-HK": [
    ...
    },
    {
      ...
      riskLevel: "HIGH",
      defaultAction: "SILENT",
      tag: "降低聲量：開喇叭睇片／講電話太大聲？",
      script: "「唔該，車廂好迫，大家細聲少少好嘛？唔該晒。」",
  ...
  "en": [
    {
      ...
      riskLevel: "LOW",
      defaultAction: "SPEAK",
      tag: "Move Inward: Door Blocked but Aisle Empty?",
    ...
    },
    {
      ...
      script: "\"Pardon me, moving center gives everyone more room, thanks!\"",
    ...
    },
    {
      ...
      defaultAction: "SPEAK",
      tag: "Need to Alight?",
      script: "\"Pardon me, stepping out so everyone has more space, thanks!\"",
    ...
    },
    {
      ...
      riskLevel: "MEDIUM",
      defaultAction: "SILENT",
      tag: "Leaning on Pole / Crowded by Backpack?",
    ...
    },
    {
      ...
      riskLevel: "MEDIUM",
      defaultAction: "SILENT",
      tag: "Exit First: Boarding Before Passengers Alight?",
      script: "\"Please wait a moment, exiting first gets everyone in faster, thanks!\"",
    ...
    },
    {
      ...
      riskLevel: "HIGH",
      defaultAction: "SILENT",
      tag: "Keep it Quiet: Loud Speaker / Phone Call?",
